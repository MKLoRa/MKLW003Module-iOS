...
static NSString *const MKLBSynDataCellIdenty = @"MKLBSynDataCellIdenty";

@interface MKLBSynDataCell ()
...
@implementation MKLBSynDataCell

+ (MKLBSynDataCell *)initCellWithTableView:(UITableView *)tableView {
    MKLBSynDataCell *cell = [tableView dequeueReusableCellWithIdentifier:MKLBSynDataCellIdenty];
    if (!cell) {
        cell = [[MKLBSynDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:MKLBSynDataCellIdenty];
    }
    return cell;
}
