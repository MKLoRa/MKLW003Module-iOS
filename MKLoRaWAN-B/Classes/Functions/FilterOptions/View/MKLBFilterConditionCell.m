...
@implementation MKLBFilterConditionCellModel
@end

@interface MKLBFilterConditionCell ()
...
@implementation MKLBFilterConditionCell

+ (MKLBFilterConditionCell *)initCellWithTableView:(UITableView *)tableView {
    MKLBFilterConditionCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKLBFilterConditionCellIdenty"];
    if (!cell) {
        cell = [[MKLBFilterConditionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKLBFilterConditionCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKLBFilterConditionCellModel *)dataModel {
    _dataModel = nil;
