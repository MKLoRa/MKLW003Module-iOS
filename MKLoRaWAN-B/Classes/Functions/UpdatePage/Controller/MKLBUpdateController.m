...
@interface MKLBUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKLBDFUModule *dfuModule;
...
@implementation MKLBUpdateController

- (void)dealloc {
    NSLog(@"MKLBUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_lb_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKLBCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_lb_centralDeallocNotification" object:nil];
...
- (MKLBDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKLBDFUModule alloc] init];
    }
    return _dfuModule;
}
