...
@interface MKLBDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKLBDFUModule

- (void)dealloc{
    NSLog(@"MKLBDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKLBCentralManager shared].peripheral];
}
