...
@implementation MKLBFirmwareCellModel
@end

@interface MKLBFirmwareCell ()
...
@implementation MKLBFirmwareCell

+ (MKLBFirmwareCell *)initCellWithTableView:(UITableView *)tableView {
    MKLBFirmwareCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKLBFirmwareCellIdenty"];
    if (!cell) {
        cell = [[MKLBFirmwareCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKLBFirmwareCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKLBFirmwareCellModel *)dataModel {
    _dataModel = nil;
