...
@implementation MKLBAboutController

- (void)dealloc {
    NSLog(@"MKLBAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-B", @"MKLBAboutController", @"lb_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UILabel *)versionLabel{
    if (!_versionLabel) {
        ...
        _versionLabel.text = @"APP Version:1.0.3";
    }
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-B", @"MKLBAboutController", @"lb_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
